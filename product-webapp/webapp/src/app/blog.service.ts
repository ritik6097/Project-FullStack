...
export class BlogService {
  ...
  public addBlogFromRemote(blog:Blog):Observable<any>{
     return this.http.post("http://localhost:8080/users/post",blog);
  }

  public registerUserFromRemote(blog:Blog):Observable<any>{
    return this.http.post("http://localhost:8080/register",blog);
 }
 public getblogdata():Observable<any>{
  return this.http.get("http://localhost:8080/users/blog")
 }
